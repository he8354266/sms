 ...
 * @author zkjy
 * @updateUser
 * @createDate 2022/2/25 10:48
 * @updateDate 2022/2/25 10:48
 * @version 1.0
 * @description zkjy
 * @author zkjy
 * @updateUser
...
public class SmsConnectLoader implements CommandLineRunner {
    ...
    public void buildNewConnect() {
        ...
        if (StringUtils.isNotBlank(token)) {
            List<ConfigEntity> list = configService.listForConnect();
    ...
    public void changeNewConnect() {
         ...
         */
        if (newConnectServer != null && ServerRegister.SERVER_ID.equals(newConnectServer)
