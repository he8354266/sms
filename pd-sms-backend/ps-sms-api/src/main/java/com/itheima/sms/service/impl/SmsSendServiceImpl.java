 ...
 * @description zkjy
 * @updateUser
 * @createDate 2022/2/10 16:42
 * @updateDate 2022/2/10 16:42
 **/
...
public class SmsSendServiceImpl implements SmsSendService {
     ...
     * @param phone
     */
    public void checkBlack(String phone) {
    ...
    private void checkoutSendTime(String sendTime) {
        if (StringUtils.isNotBlank(sendTime)) {
            LocalDateTime localDateTime = LocalDateTime.parse(sendTime, DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm"));
    ...
    private void pushSmsMessage(TemplateEntity templateEntity, SmsSendDTO smsSendDTO, PlatformEntity platformEntity) {
        ...
        try {
            ...
            if (StringUtils.isNoneEmpty(sendTime)) {
                //定时发送，需要将信息保存到mysql
